...
const development = {
  ...
  API_URL_GET_POST_BY_ID: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.API_URL_GET_POST_BY_ID}`,
...
const production = {
  ...
  API_URL_GET_POST_BY_ID: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.API_URL_GET_POST_BY_ID}`,
